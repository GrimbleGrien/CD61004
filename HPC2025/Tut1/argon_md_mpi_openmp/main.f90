...
program mainprogram
 ...
 real(kind=dp) :: PE,KE,elapsed_time_sec
...
! call cpu_time(t1)    
 CALL DATE_AND_TIME(VALUES=ts1)

! write(5000,"(a,2x,f10.2)") "Time (in sec): ",t1-t0 
! write(*,"(a,2x,f10.2)") "Time (in sec): ",t1-t0 


elapsed_time_sec =   REAL(ts1(5) - ts0(5)) * 3600.0 + &
                     REAL(ts1(6) - ts0(6)) * 60.0 + &
                     REAL(ts1(7) - ts0(7)) + &
                     REAL(ts1(8) - ts0(8)) / 1000.0

 write(5000,"(a,2x,f10.2)") "Time (in sec): ",elapsed_time_sec
 write(*,"(a,2x,f10.2)") "Time (in sec): ",elapsed_time_sec
